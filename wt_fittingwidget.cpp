...
#include "ui_wt_fittingwidget.h" // [修改] 对应新的 UI 文件名
    ...
    m_isFitting(false)
{
    ...
    // 设置分割器比例，左侧控制面板略宽一点，右侧绘图区域占大部分
    ui->splitter->setSizes(QList<int>{350, 750});
